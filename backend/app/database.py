...
def _ensure_sqlite_columns() -> None:
    ...
    additions = {
        "system_settings": {
            ...
            "external_gallery_webdav_url": "TEXT NOT NULL DEFAULT ''",
            "external_gallery_webdav_username": "TEXT NOT NULL DEFAULT ''",
            "external_gallery_webdav_password": "TEXT NOT NULL DEFAULT ''",
            "external_gallery_webdav_path": "TEXT NOT NULL DEFAULT ''",
            "external_gallery_max_items": "INTEGER NOT NULL DEFAULT 2000",
            "external_gallery_max_depth": "INTEGER NOT NULL DEFAULT 16",
