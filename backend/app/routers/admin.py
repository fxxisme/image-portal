...
def _settings_out(row) -> SystemSettingsOut:
    return SystemSettingsOut(
        ...
        moderation_base_url=row.moderation_base_url or "",
        moderation_api_key_masked=mask_api_key(row.moderation_api_key or ""),
        has_moderation_api_key=bool((row.moderation_api_key or "").strip()),
        moderation_model=row.moderation_model or "",
        ...
        external_gallery_max_items=max(1, min(row.external_gallery_max_items or 60, 200)),
...
def update_settings_api(
    ...
    row = apply_settings_update(
        ...
        moderation_base_url=body.moderation_base_url,
        moderation_api_key=body.moderation_api_key,
        moderation_model=body.moderation_model,
